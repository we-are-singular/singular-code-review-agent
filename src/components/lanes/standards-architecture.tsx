...
export const StandardsArchitectureLane: AML.Component = () => {
  return (
    <>
      ...
      <ReviewLane lane="standards-architecture">
        ...
        <Block multiline>{`
          ...
          - Ground every comment in a local rule or demonstrated repository pattern; leave local simplification and scan-cost cleanup to the elegance lane and reachable runtime failures to the bug lane.
        `}</Block>
      </ReviewLane>
    </>
  )
