  ...
  return (
    <>
      ...
      <ReviewLane lane="intent-contract">
        ...
        Stage non-code scope, relationship, or closing-contract concerns through `add_review_note` even when the
        pull request may land unchanged; notes are advisory.
      </Block>
      </ReviewLane>
    </>
  )
