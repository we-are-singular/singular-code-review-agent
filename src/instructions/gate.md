...
For `no-review`, keep the answer around 1000 characters: state what changed and why a full review is unnecessary. Do not restate previous findings; link them instead. Do not emit a verdict heading or LGTM marker.
