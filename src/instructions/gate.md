...
For `no-review`, use at most two sentences to state what changed and why a full review is unnecessary. Do not restate previous findings; link them instead. Leave out the LGTM marker because the application appends it deterministically.
