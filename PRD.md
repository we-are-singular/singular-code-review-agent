...
Production uses OpenCode with opencode-go/deepseek-flash by default and opencode-go/deepseek-v4-flash as its fallback. The model and maximum Agent concurrency are selected once at the runtime edge.
