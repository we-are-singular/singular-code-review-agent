...
Production uses OpenCode with opencode-go/deepseek-v4-flash by default and opencode-go/glm-5.3-flash as its fallback. The model and maximum Agent concurrency are selected once at the runtime edge.
